...
public class WordCounter {
	//RH private static final String EOL = System.getProperty("line.separator");  for working properly no matter
	//what OS you are on
	//RH private static final String DELIMITERS = *,.!?\t"+EOL; for defining delimiters, for string tokenizer
	...
	public int countWords(String source) {
		//RH StringTokenizer st = new StringTokenizer(text, DELIMITERS);
		//return st.countTokens();
		//Or
		//return (new StringTokenizer(text, DELIMITERS)).countTokens();
 ...
 */
	public void countWord(String source, String word) {
		...
		//int count = 0;
		//while (st.hasMoreElements)){
		//String curentWord = st.nextToken();
